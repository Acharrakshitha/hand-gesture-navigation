...
class GestureController:
    ...
    # ======= ADDED: clean stop method (minimal change) =======
    @staticmethod
    def stop():
        """Stops gesture navigation loop and releases resources."""
    ...
    # (Optional helper, safe to use; not required)
    @staticmethod
    def is_running():
        return GestureController.gc_mode == 1
